...
However, depending on your model it might be a better idea to start from another configures project.
...
./config/cluster/resources/Eddie_CraftyTestModel_Single.sh
